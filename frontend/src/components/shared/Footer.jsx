...
const Footer = () => {
  return (
    <footer className="bg-white/80 rounded-t-2xl shadow-lg border-t border-gray-100 glass-effect py-8 mt-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-blue-700">PathWiser</h2>
            <p className="text-sm text-gray-500">© {new Date().getFullYear()} Your Company. All rights reserved. Made in India with ❤️</p>
          </div>
